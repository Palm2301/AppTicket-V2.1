...
const STORAGE_KEYS = {
  ASSETS: 'xt_assets_v1',
  TRANSFERS: 'xt_transfers_v1',
  TICKETS: 'xt_tickets_v1',
  STAFF: 'xt_staff_v1',
  BRANCHES: 'xt_branches_v1',
  DEPARTMENTS: 'xt_departments_v1',
  TECHNICIANS: 'xt_technicians_v1',
  CURRENT_USER_ID: 'xt_current_user_id_v1',
  FORM_CONFIG: 'xt_form_config_v1',
